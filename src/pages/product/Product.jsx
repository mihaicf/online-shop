                ...
                <div className="product-page container-fluid container-min-max-width">
                    ...
                    <div className="product-info d-flex">
                        ...
                        <div className="product-details">
                            <p className="h3 text-danger mb-3">{product.price} {product.currency}</p>
                            <button
                            ...
                            <p><span className="font-weight-bold mb-3">Color</span>: {product.colour}</p>
                            <p><span className="font-weight-bold mb-3">Brand</span>: {product.brand}</p>
